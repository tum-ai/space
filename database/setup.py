...
async def setup_db_client(running_app: FastAPI):
    ...
    running_app.state.mongodb_client = AsyncIOMotorClient("mongodb://admin:password@localhost:27017/")
    await init_beanie(database=running_app.state.mongodb_client["tumai-space"], document_models=document_models)
