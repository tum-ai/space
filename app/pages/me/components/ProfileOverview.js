    ...
    <div className="m-auto max-w-3xl bg-white dark:bg-gray-700">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 p-8 px-4 lg:px-10 rounded-xl">
        ...
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">DEPARTMENT</div>
        ...
        {/* semester */}
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">SEMESTER</div>
          <div className="font-light text-base">
        ...
        {/* university */}
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">UNIVERSITY</div>
          <div className="font-light text-base">{profile.university}</div>
        </div>
        {/* description  */}
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">DESCRIPTION</div>
          <div className="font-light text-base">
            {profile.description || "-"}
          </div>
        </div>
        ...
        {/* current job */}
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">CURRENT JOB</div>
          <div className="font-light text-base">
            {profile.currentJob || "-"}
          </div>
        </div>
        {/* nationality */}
        <div className="flex flex-col">
          <div className="text-base text-gray-400 font-light">NATIONALITY</div>
          <div className="font-light text-base">
            {profile.nationality || "-"}
          </div>
        </div>
