    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "learning_from_project_failure": "I learned the importance of thorough testing and user feedback.",
                "expectations": "I expect to learn and grow in a collaborative environment.",
                "what_want_to_do": "I want to work on challenging projects and make a meaningful impact.",
                ...
                "num1_department_reasoning": "I have a strong background in data analysis.",
                "num2_department_reasoning": "I enjoy coding and building software solutions.",
                "num3_department_reasoning": "I have experience in managing product development processes.",
                "department_reasoning": "I believe these departments align with my skills and interests.",
                "research_development_interest": True,
                "research_development_reasoning": "I'm interested in exploring cutting-edge technologies.",
...
class MembershipApplicationListOut(BaseModel):
    ...
    def dummy(cls) -> "MembershipApplicationListOut":
        return MembershipApplicationListOut.parse_obj(cls.Config.schema_extra["example"])
