...
class MembershipApplicationReviewListOut(BaseModel):
    id: int
    motivation: int
    skill: int
    fit: int
    ...
    def from_db_model(
        ...
        return MembershipApplicationReviewListOut(
            id=review.id,
    ...
    @classmethod
    def dummy(cls) -> "MembershipApplicationReviewListOut":
        return MembershipApplicationReviewListOut.parse_obj(
